...
function setup() {
  ...
  launcherObj=new Launcher(stoneObj.body,{x:100,y:465});
...
function keyPressed(){
	if(keyCode===32){
		Matter.Body.setPosition(stoneObj.body,{x:305,y:420});
